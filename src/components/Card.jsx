...
export default function Card(props) {
	...
	return (
		// <div onClick={handleClick} className="flex mx-4 bg-[#04471C] px-4 py-4 shadow-lg max-h-[136px] w-[90%] cursor-pointer gap-2 rounded-[10px] items-start">
		<div className="flex min-w-[20rem] max-w-xs gap-2 rounded-xl bg-palette-300 p-4">
